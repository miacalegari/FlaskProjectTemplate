...
- 🎯 Entry points to execute your program using `python -m <flaskprojecttemplate>` or `$ flaskprojecttemplate` with basic CLI argument parsing.
...
---
# flaskprojecttemplate Flask Application

Awesome flaskprojecttemplate created by miacalegari
...
```bash
git clone https://github.com/miacalegari/FlaskProjectTemplate flaskprojecttemplate
cd flaskprojecttemplate
make install
```
...
```bash
pip install flaskprojecttemplate
```
...
```bash
flaskprojecttemplate create-db   # run once
flaskprojecttemplate populate-db  # run once (optional)
flaskprojecttemplate add-user -u admin -p 1234  # ads a user
flaskprojecttemplate run
```
